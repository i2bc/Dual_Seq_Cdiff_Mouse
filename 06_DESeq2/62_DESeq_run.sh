...
# $2 : value of --condRef
# $3 : name of effet batch column or NULL
...
Rscript ../sartools_script_DESeq2_CL.r --projectName=${analyse} --targetFile=../${analyse}.txt --rawDir=../fc_data --varInt=group --condRef=$2 --batch=$3
